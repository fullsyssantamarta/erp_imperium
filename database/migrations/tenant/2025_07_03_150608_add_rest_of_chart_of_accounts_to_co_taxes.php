...
class AddRestOfChartOfAccountsToCoTaxes2 extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('co_taxes')->where('name', 'RETE.FUENTE')->update([
            'chart_account_purchase' => '23654001',
            'chart_account_sale' => '13551501',
            'chart_account_return_purchase' => '23654002',
            'chart_account_return_sale' => '13551502',
        ]);

        DB::table('co_taxes')->where('name', 'IVA19AIU')->update([
            'chart_account_purchase' => '24081503',
            'chart_account_sale' => '24080503',
            'chart_account_return_purchase' => '24082003',
            'chart_account_return_sale' => '24081003',
        ]);
    }
