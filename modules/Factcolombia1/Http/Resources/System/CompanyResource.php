...
class CompanyResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'plan_started_at' => $this->plan_started_at ? $this->plan_started_at->format('Y-m-d') : null,
            'plan_expires_at' => $this->plan_expires_at ? $this->plan_expires_at->format('Y-m-d') : null,
            'plan_auto_renew' => $this->plan_auto_renew,
            'plan_active' => $this->plan_active,
            ...
            'api_token' => $service_company->api_token(),
            'modules' => $modules,
        ];
    }
}
