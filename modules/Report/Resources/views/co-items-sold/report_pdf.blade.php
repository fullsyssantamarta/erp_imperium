                        ...
                        <tbody>
                            ...
                            @foreach($grouped_records as $group)
                                ...
                                <tr>
                                    ...
                                    <td class="celda">{{ $utility > 0 ? number_format(($utility * 100) / $net_value, 2) : 0 }}</td>
                            ...
                            <tr>
                                ...
                                <td class="celda">{{ $total_utility > 0 ? number_format(($total_utility * 100) / $total_net_value, 2) : 0 }}</td>
